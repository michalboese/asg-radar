...
<template>
  <BaseContainer>
    ...
    <BaseCard variant="toned" color="#6B4226">
      ...
      <template v-slot:actions>
        <BaseButton @click="signInToFirebase" variant="tonal" color="#4B5320"> Sign In </BaseButton>
        <BaseButton @click="createUser" variant="tonal" color="#A97142" outline>
          Create New User
        </BaseButton>
      </template>
    </BaseCard>
